...
``` r
birthweight_model = lm(bwt ~ momage + ppbmi + wtgain + smoken + gaweeks + pnumlbw + pnumsga + bhead, data = birthweight_df)
...
```
    ...
    ##     pnumlbw + pnumsga + bhead, data = birthweight_df)
    ## 
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -1136.14  -221.09    -5.68   217.76  2200.45 
    ## 
    ## Coefficients: (2 not defined because of singularities)
    ##               Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) -5205.3123   109.6443 -47.475  < 2e-16 ***
    ## momage          7.8664     1.3032   6.036 1.71e-09 ***
    ## ppbmi           6.6605     1.5766   4.224 2.44e-05 ***
    ## wtgain          5.4693     0.4688  11.668  < 2e-16 ***
    ## smoken         -3.6640     0.6728  -5.446 5.45e-08 ***
    ## gaweeks        22.5704     1.7100  13.199  < 2e-16 ***
    ## pnumlbw             NA         NA      NA       NA    
    ## pnumsga             NA         NA      NA       NA    
    ## bhead         208.6400     3.3707  61.899  < 2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 326 on 4335 degrees of freedom
    ## Multiple R-squared:  0.5954, Adjusted R-squared:  0.5949 
    ## F-statistic:  1063 on 6 and 4335 DF,  p-value: < 2.2e-16
