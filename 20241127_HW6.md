...
- A group of mum’s characteristics such as Age at delivery (momage),
  pre-pregnancy BMI (ppbmi), weight gain during pregnancy (wtgain), and
  smoking behavior (smoken).
...
``` r
birthweight_model = lm(bwt ~ momage + ppbmi + smoken + gaweeks + pnumlbw + pnumsga + bhead + blength, data = birthweight_df)
...
```
    ...
    ## 
    ## Call:
    ## lm(formula = bwt ~ momage + ppbmi + smoken + gaweeks + pnumlbw + 
    ##     pnumsga + bhead + blength, data = birthweight_df)
    ## 
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -1152.06  -187.66   -10.85   177.21  2556.75 
    ## 
    ## Coefficients: (2 not defined because of singularities)
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) -6275.082     98.865 -63.471  < 2e-16 ***
    ## momage          5.950      1.131   5.260 1.51e-07 ***
    ## ppbmi           2.999      1.368   2.193 0.028382 *  
    ## smoken         -2.121      0.588  -3.607 0.000313 ***
    ## gaweeks        14.391      1.509   9.534  < 2e-16 ***
    ## pnumlbw            NA         NA      NA       NA    
    ## pnumsga            NA         NA      NA       NA    
    ## bhead         137.004      3.526  38.854  < 2e-16 ***
    ## blength        81.107      2.078  39.038  < 2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 284.8 on 4335 degrees of freedom
    ## Multiple R-squared:  0.6912, Adjusted R-squared:  0.6908 
    ## F-statistic:  1618 on 6 and 4335 DF,  p-value: < 2.2e-16
