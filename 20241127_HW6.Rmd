...
* A group of mum's characteristics such as Age at delivery (momage), pre-pregnancy BMI (ppbmi), weight gain during pregnancy (wtgain), and smoking behavior (smoken).
